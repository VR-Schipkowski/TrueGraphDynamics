...
Raw post text is transformed into a fixed-dimensional numerical
representation using a pre-trained transformer model.

For each post, the text is tokenized and passed through the
transformer. The contextualized embedding of the \texttt{[CLS]}
token is extracted as a holistic representation of the post.
